              ...
              <tr>
                <td className="table-column-pe-0">
                  <div className="form-check">
                    ...
                    <label className="form-check-label" htmlFor="usersDataCheck6"></label>
                  </div>
                </td>
                <td className="table-column-ps-0">
                  <a className="d-flex align-items-center" href="./ecommerce-customer-details.html">
                    ...
                    <div className="flex-grow-1 ms-3">
                      <span className="h5 text-inherit">Ella Lauda <i className="bi-patch-check-fill text-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Top endorsed"></i></span>
                    </div>
                  </a>
                </td>
                <td>ella@site.com</td>
              ...
              <tr>
                <td className="table-column-pe-0">
                  <div className="form-check">
                    ...
                    <label className="form-check-label" htmlFor="usersDataCheck7"></label>
                  </div>
                </td>
                <td className="table-column-ps-0">
                  <a className="d-flex align-items-center" href="./ecommerce-customer-details.html">
              ...
              <tr>
                <td className="table-column-pe-0">
                  <div className="form-check">
                    ...
                    <label className="form-check-label" htmlFor="usersDataCheck16"></label>
                  </div>
                </td>
                <td className="table-column-ps-0">
                  <a className="d-flex align-items-center" href="./ecommerce-customer-details.html">
